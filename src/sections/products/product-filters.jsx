...
export const GENDER_OPTIONS = ['Premium', 'Standard'];
export const CATEGORY_OPTIONS = ['Ordinateurs', 'Residence Meublee', 'Telephone', 'Appareils', 'Vetements', 'Autres'];
export const RATING_OPTIONS = ['up4Star', 'up3Star', 'up2Star', 'up1Star'];
export const VERIFY_OPTIONS = ['Verifier', 'Non verifier'];
